module.exports = (MailBody) => {
    ...
    <head>
        ...
        <style>
            ...
            .wrapper .content-wrapper .content p span {
                color: #333333;
                font-family: 'Roboto', 'Regular';
            }
    ...
    <body>
        <div class="container">
            <div class="wrapper">
                <div class="logo">
                    <img src="../../public/images/logos/${MailBody.domain}.png">
                </div>
                <div class="content-wrapper">
                    ...
                    <div class="content">
                        <p>Welcome to
                            <a href="${MailBody.domain_url}">${MailBody.domain_name}.</a>
                            Please click below to verify your email.
                        </p>
                    </div>
                    <div class="cta">
                        <a href="${MailBody.verifyLink}">Verify your Email</a>
                    </div>
                    <p class="note">If you are unable to click the above "Verify your Email" button, please copy this URL in your browser : <a href="${MailBody.verifyLink}">${MailBody.verifyLink}</a></p>
                    <div class="signature">
                        <p>Best Regards,</p>
